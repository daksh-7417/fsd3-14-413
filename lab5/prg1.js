...
const dirname = path.dirname(filename)  // store the adderess of project folder


app.get("/",(req,res)=>{
    res.sendFile(path.join(dirname,"public","index.html")); // project foler/public/index.html
})
